...
const LightBulb = () => {
    ...
    return(
        <div className="container-fluid text-right dark-bulb">
            <button className="btn dark-mode-btn" id="nmode" ><i id="bulb" className="far fa-lightbulb fa-3x"></i></button>
         </div>
    )
    ...
    function nightRun() {
        ...
        document.documentElement.style.setProperty(('--background'), 'radial-gradient(ellipse  at ' + ((rect.left + rect.right) / 2) + 'px ' + (rect.top + 20) + 'px, rgb(240, 255, 240) 0%, rgb(240, 255, 240) ' + t + '%, rgb(20,20,20) ' + b + '%, rgb(20,20,20) 100%)');
